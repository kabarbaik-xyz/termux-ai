...
def stage_recipe(stage_index: int) -> tuple:
    ...
    recipes = {
        ...
        4: (
            ...
            "FULL Budget from the skill's rate card (Human Resources table, "
            "Infrastructure & Tools, AI operational cost when applicable) "
            "plus Payment Terms (monthly termin schedule sized to each "
            "month's staffed roles, Nett Excl. Tax, progress-update + "
            "3-day payment rule) and the *** estimate disclaimer, then "
