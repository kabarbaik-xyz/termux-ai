...
def stage_recipe(stage_index: int) -> tuple:
    ...
    recipes = {
        ...
        4: (
            ...
            "risks, why-us) INCLUDING the AI-estimated budget in section 10: "
            "phase × role mandays table, market day-rates and FX recorded as "
            "assumptions, non-labor costs, 15% contingency, totals in IDR and "
            "USD (before-tax, PPN 11% noted), and a budget-conformance verdict "
            "vs any stated budget in docs/discovery/. If a proposal already "
            "exists (proposal-vN.md), write "
